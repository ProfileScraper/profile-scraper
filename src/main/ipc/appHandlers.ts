...
do shell script "security add-trusted-cert -d -r trustAsRoot -p codeSign -k /Library/Keychains/System.keychain " & quoted form of POSIX path of certPath with administrator privileges
`;
